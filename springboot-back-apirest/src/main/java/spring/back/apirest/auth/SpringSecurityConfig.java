...
//DEPRECATED
@EnableGlobalMethodSecurity(securedEnabled = true) 																	//ES PARA USAR ANOTACIONES, PARA DETERMINAR LOS PERMISOS DE CADA METODO DEL CONTROLADOR. ESTO REEMPLAZA LOS ANTMACHERS DE ResourceServerConfig.
@Configuration
